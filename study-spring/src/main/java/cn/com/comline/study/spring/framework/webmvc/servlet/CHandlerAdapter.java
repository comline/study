...
import cn.com.comline.study.spring.framework.annotation.CPRequestParam;
...
public class CHandlerAdapter {
    public boolean supports(Object handler) {
        return (handler instanceof CHandlerMapping);
    }

    public CModelAndView handle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        CHandlerMapping handlerMapping = (CHandlerMapping) handler;
        ...
        boolean isModelAndView = handlerMapping.getMethod().getReturnType() == CModelAndView.class;
        if (isModelAndView) {
            return (CModelAndView) result;
        }
        return null;
    }
