package cn.com.comline.study.studyspringmvc.springmvc.v3.servlet;

import cn.com.comline.study.studyspringmvc.springmvc.annotation.*;
...
public class CDispatcherServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        //调用doGet或者doPost方法
        //提示信息
        System.out.println("Comline Spring framework is init.");
    }
        ...
        private void putParamIndexMapping(Method method) {
            ...
            for (int i = 0; i < pa.length; i++) {
                for (Annotation a : pa[i]) {
                    if (a instanceof CRequestParam) {
                        String paramName = ((CRequestParam) a).value();
