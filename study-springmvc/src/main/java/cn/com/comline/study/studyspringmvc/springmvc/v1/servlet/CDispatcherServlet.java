package cn.com.comline.study.studyspringmvc.springmvc.v1.servlet;
...
/**
 * <p>Package: cn.com.comline.study.studyspringmvc.codingspringmvc.v1</p>
 * <p>ClassName: CDispatcherServlet </p>
 * <p>description：利用反射原理 模拟springmvc的核心原理</p>
 * <p>Copyright (c) www.island.ren 2019</p>
 * <p>author: comline@foxmail.com</p>
 * <p>create: 2019-07-10 00:46</p>
 **/
public class CDispatcherServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        InputStream is = null;
        try {
            Properties configContxt = new Properties();
            is = this.getClass().getClassLoader().getResourceAsStream(config.getInitParameter("contextConfigLocation"));
            configContxt.load(is);
            String scanPackage = configContxt.getProperty("scanPackage");
            ...
            for (String className : mapping.keySet()) {
                ...
                if (clazz.isAnnotationPresent(CController.class)) {
                    mapping.put(className, new Object());
                    String baseUrl = "";
                    ...
                    CService service = clazz.getAnnotation(CService.class);
    ...
    private void doScanner(String scanPackage) {
        ...
        for (File file : calssDir.listFiles()) {
            if (file.isDirectory()) {
                ...
                if(className.contains("CDispatcherServlet") || className.contains("annotation")){
                    continue;
                }
